...
map ,s :VimShellSendString<return>
command OCaml VimShellInteractive ocaml
command Ruby VimShellInteractive pry
command GHCi VimShellInteractive ghci
command SML VimShellInteractive sml

autocmd FileType ocaml set shiftwidth=2 tabstop=2 expandtab
autocmd FileType make set shiftwidth=4 tabstop=4 expandtab
